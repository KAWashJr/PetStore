...
public class UserModuleTestsFromProperties {

    Faker faker;
    User userPayload;
    private final static Logger log = LogManager.getLogger(UserModuleTestsFromProperties.class);
    ...
    public void testUpdateUserByName() {
        ...
        Response responseAfterPutRequest = UserEndpointsFromProperties.readUser(this.userPayload.getUsername());
    ...
    public void testDeleteUserByName() {
        ...
        Response responseAfterDeleteRequest = UserEndpointsFromProperties.readUser(this.userPayload.getUsername());
